...
The configuration of dwm is done by changing files in ~config.h~ and recompiling the source code.
- In NixOS, this is done by rebuilding.
- In Arch, this is done by navigating to the dwm directory and running,
...
satic const char col_black[]       = "#000000";
